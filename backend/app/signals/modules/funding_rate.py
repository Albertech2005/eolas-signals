...
#
THRESHOLD_EXTREME_LONG  =  0.0005   # +0.05%/8h → truly extreme → SHORT bias (strong)
THRESHOLD_HIGH_LONG     =  0.00012  # +0.012%/8h → elevated above neutral → SHORT bias (weak)
THRESHOLD_HIGH_SHORT    = -0.00003  # -0.003%/8h → any notable negative funding → LONG bias (weak)
THRESHOLD_EXTREME_SHORT = -0.0003   # -0.03%/8h → extreme negative → LONG bias (strong)
